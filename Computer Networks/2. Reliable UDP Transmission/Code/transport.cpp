...
TransportLayer::TransportLayer(const std::string &src_IP, const int16_t src_port) {
...
int TransportLayer::get_msg(char *recv_buf, int16_t buf_len, int timeout) {
...
int TransportLayer::send_msg(const std::string &dest_IP, const int16_t dest_port, char *send_buf, int16_t msg_len) {
