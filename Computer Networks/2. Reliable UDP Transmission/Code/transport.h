...
class TransportLayer {
   ...
   public:
    TransportLayer(const std::string &src_IP, const int16_t src_port);
    ~TransportLayer();
    ...
    int send_msg(const std::string &dest_IP, const int16_t dest_port, char *send_buf, int16_t msg_len);
};
